  ...
  const teamMembers = [
    {
      ...
      bio: "Mike has spent his career at several leading financial institutions and brings a mix of investing, banking, and capital markets experience to the firm. Prior to joining, Mike was an Investment Professional at Huron Capital Partners ($2Bn+ AUM), where he focused on evaluating and executing LBOs and buy-and-build strategies across both a $600MM buyout fund and a $125MM small-cap fund, holding multiple board roles and driving portfolio company value creation. He also held roles at Hudson Avenue Partners, where he assisted in developing and growing the startup Investment Bank, partnering with PE sponsors and founder-led companies to structure and advise on capital strategies and early-stage value creation. Earlier in his career, Mike advised on M&A, debt financings, and equity recapitalizations in Bank of America Merrill Lynch's NYC Consumer & Retail Investment Banking group and underwrote senior secured facilities for founder-owned companies and financial sponsors at Wells Fargo Capital Finance. A former professional minor-league hockey player, Mike brings a competitive, disciplined, and team-oriented approach to leadership and value creation. Mike received his MBA from the University of Michigan – Ross School of Business with Distinction and a BBA in Finance from Western Michigan University.",
