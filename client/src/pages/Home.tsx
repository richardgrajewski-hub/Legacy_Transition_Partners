            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                <div className="bg-white mb-4 h-64 flex items-center justify-center">
                  <img src="/images/commercial-facility-icon.png" alt="Commercial & Facility Services Icon" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="text-center">
                <div className="bg-white mb-4 h-64 flex items-center justify-center">
                  <img src="/images/industrial-services-icon.png" alt="Industrial Services Icon" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="text-center">
                <div className="bg-white mb-4 h-64 flex items-center justify-center">
                  <img src="/images/residential-services-icon.png" alt="Residential Services Icon" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="text-center">
                <div className="bg-white mb-4 h-64 flex items-center justify-center">
                  <img src="/images/specialty-distribution-icon.png" alt="Specialty Distribution Icon" className="w-full h-full object-contain" />
                </div>
