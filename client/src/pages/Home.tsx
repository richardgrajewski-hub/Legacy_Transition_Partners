      ...
      <nav className={`fixed top-0 w-full z-50 transition-all ${isScrolled ? "bg-white shadow-md" : "bg-white"}`} style={{height: '127px'}}>
        <div className="container mx-auto px-4 py-0 flex items-center justify-between" style={{height: '114px'}}>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/Legacy%20Transition%20Partners%20Overview.pdf" download="Legacy Transition Partners Overview.pdf" className="text-foreground hover:text-primary transition-colors font-semibold link-underline" style={{fontSize: '20px'}}>Investment One-Pager</a>
          </div>
          <MobileMenu />
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card-elevated" style={{borderLeft: '4px solid #D4A574'}}>
              ...
              <ul className="space-y-3 text-muted-foreground">
                ...
                <li style={{fontSize: '20px'}}><span style={{color: '#D4A574', fontWeight: 'bold'}}>•</span> Opportunities to grow through thoughtful expansion and selective<br/><span style={{display: 'inline-block', paddingLeft: '16px'}}>acquisitions</span></li>
