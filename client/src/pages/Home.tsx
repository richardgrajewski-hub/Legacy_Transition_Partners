      ...
      <footer className="bg-slate-700 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-8">
            <img src="/images/ltp-logo-footer-transparent.jpg" alt="Legacy Transition Partners" className="h-40 w-auto mb-6 p-4" style={{filter: 'brightness(0) invert(1)', backgroundColor: '#334155'}} />
            <div>
